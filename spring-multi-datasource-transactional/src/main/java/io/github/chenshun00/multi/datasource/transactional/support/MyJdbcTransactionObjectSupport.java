 ...
 */
public abstract class MyJdbcTransactionObjectSupport implements SavepointManager, SmartTransactionObject {

    private static final Log logger = LogFactory.getLog(MyJdbcTransactionObjectSupport.class);


    @Nullable
    private MyConnectionHolder connectionHolder;
     ...
     */
    public void setConnectionHolder(@Nullable MyConnectionHolder connectionHolder) {
